...
class CalculatorTests {
     ...
     * You'll need to annotate it with @get:Rule, which specifies that the subsequent rule,
     * in this case launching an activity, should execute before every test in the class.
     * Test rules are an essential tool for testing.
     */
    @get:Rule
